...
import { ConsultorWebScraper2 } from "../bot/scraper/Consultor.WebScraper2";
import { Alumno_credencial_login } from "../types/ConsultorEstudianteCredenciales.types";
import { ConsultorWebParser2 } from "../bot/parser/Consultor.WebParser2";
...
export class ConsultorDataService2 implements IConsultorDataProvider{
