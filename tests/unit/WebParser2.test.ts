...
import { ConsultorWebParser2 } from '../../src/bot/parser/Consultor.WebParser2';
...
describe("Tests del webparser del consultor", ()=> {
    ...
    beforeEach(()=>{
        const html: string = utils.read_File(`${resources}/consultor_json_sucio_html.txt`);
        parser = new ConsultorWebParser2(html);
    });
